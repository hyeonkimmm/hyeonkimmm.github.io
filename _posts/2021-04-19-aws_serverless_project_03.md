---
title : "AWS serverless front end"
category :
    - AWS
    - Server less
tag :
...
```
# getmdl.io
# 라이센스 받아오기https://raw.githubusercontent.com/google/material-design-lite/mdl-1.x/LICENSE
wget https://raw.githubusercontent.com/google/material-design-lite/mdl-1.x/LICENSE
```
- wget: command not found 일 때
```
yum install wget
```
...
<html lang="kr">
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/dialog-polyfill/0.5.0/dialog-polyfill.css" type="text/css" media="screen" title="no title" charset="utf-8">
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout--fixed-tabs">
      ...
      <main class="mdl-layout__content">
                  ...
                  <div class="mdl-card__supporting-text">
                    <form action="#">
                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <select class="mdl-textfield__input" type="text" id="type">
                          <option value="Serverless Web Project">Serverless Web Project</option>
                          <option value="About Cloud Computing">About Cloud Computing</option>
                        </select>
                        <label class="mdl-textfield__label" for="type">Conference Type</label>
                      </div>
                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                      ...
                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="phone_number">
        ...
        <section class="mdl-layout__tab-panel" id="fixed-tab-2">
          <div class="page-content"><!-- Your content goes here -->
            ...
            <div id="showBox" class="mdl-dialog__content">
              <img src="http://placehold.it/400x250?text=image" alt="">
            </div>
      ...
      <footer class="mdl-mini-footer">
        <div class="mdl-mini-footer__left-section">
          <div class="mdl-logo">Conference</div>
...
.demo-card-wide.mdl-card {
  ...
  .demo-card-wide > .mdl-card__title {
    color: #fff;
    height: 250px;
    background: url('http://placehold.it/300x300?text=loading') center;
  }
